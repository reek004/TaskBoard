            ...
            <div className="bg-white rounded-lg shadow-md p-4">
              <form onSubmit={handleAddTask} className="space-y-3">
                <textarea
                  ...
                  className="w-full px-3 py-2 border-none resize-none focus:outline-none text-sm bg-gray-50 rounded-lg"
                  rows={3}
                  autoFocus
                />
                <div className="flex gap-2">
                  <button
                    type="submit"
                    className="px-3 py-1.5 bg-blue-600 text-white text-sm rounded-lg hover:bg-blue-700 transition-colors shadow-md"
                  >
                    Add card
                  </button>
                  <button
                    ...
                    className="px-3 py-1.5 text-gray-600 text-sm rounded-lg hover:bg-gray-100 transition-colors shadow-md bg-gray-50"
                  >
                    Cancel
                  </button>
                </div>
